...
TOOL_POLICY: Dict[str, str] = {
    ...
    "browse_page": POLICY_CHECK,
    "browser_action": POLICY_CHECK,
    "list_github_prs": POLICY_CHECK,
    "get_github_pr": POLICY_CHECK,
    "list_github_issues": POLICY_CHECK,
    "get_github_issue": POLICY_CHECK,

...
MODEL_PRICING_STATIC = {
    ...
    "gigachat::GigaChat": (0.72, 0.72, 0.72),
    # DeepSeek pricing (per 1M tokens, input/cached/output).
    # https://api-docs.deepseek.com/quick_start/pricing
    "deepseek/deepseek-chat": (0.14, 0.07, 0.14, 0.28),
...
def infer_api_key_type(model: str, provider: Optional[str] = None) -> str:
    ...
    if provider_name in {"local", "openrouter", "openai", "anthropic", "deepseek", "minimax", "xiaomi", "openai-compatible", "cloudru", "gigachat"}:
